...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E139BBE8DD830");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BEDACAB65A9");
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnosi__0C54CC73247D1949");
        ...
        {
            entity.HasKey(e => e.EncounterId).HasName("PK__Encounte__4278DD366275EB91");

            entity.ToTable("Encounter");

            entity.HasIndex(e => new { e.AdmitDate, e.DischargeDate }, "NCI-Admit Date");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231A2432B0370B");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC366C0F69ACB");
            ...
            entity.HasIndex(e => e.Mrn, "UQ__Patient__C790FDB4004DD376").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProcedureId).HasName("PK__Procedur__54C2E52D8B7C49B1");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687D802926DB");
